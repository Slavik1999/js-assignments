...
function isLeapYear(date) {
  ...
  return new Date(newDate, 1, 29).getDate() === 29;
}
...
function timeSpanToString(startDate, endDate) {
  ...
  let h = Math.trunc((rez / 3600000) % 100)
    .toString()
    .padStart(2, "0");
  let m = Math.trunc((rez / 60000) % 60)
    .toString()
    .padStart(2, "0");
  let s = Math.trunc((rez / 1000) % 60)
    .toString()
    .padStart(2, "0");
  let ms = Math.trunc(rez % 1000)
    .toString()
    .padStart(3, "0");
  return h + ":" + m + ":" + s + "." + ms;
